#!/usr/bin/env python3
"""
Deploy the CORRECT build from website/dist/ to Cloudflare Pages
This fixes the reverted deployment issue
"""
import json
import hashlib
import os
...
# CORRECT build directory with hero slideshow and all new photos
DEPLOY_DIR = Path('/data/.openclaw/workspace/company-theatre/website/dist')
...
# Build manifest
print("🔍 Building manifest from CORRECT build directory...")
